    ...
    return (
        <header className="bg-gray-800 shadow-md sticky top-0 z-50">
            <div className="container mx-auto flex justify-between items-center px-6 py-4">
                <Link href="/galeria">
                    <h1 className="text-2xl font-bold text-white">Image.io</h1>
                </Link>
...
const Footer: React.FC = () => {
    return (
        <footer className="bg-gray-800 shadow-inner mt-8">
            <div className="container mx-auto text-center py-6 text-gray-400 text-sm">
                Desenvolvido por Guilherme Yuji
            </div>
        </footer>
    )
}
...
const Loading: React.FC = () => {
    return (
        <div role="status">
            <svg
                aria-hidden="true"
                className="inline w-10 h-10 text-gray-600 animate-spin fill-blue-400"
                viewBox="0 0 100 101"
                fill="none"
